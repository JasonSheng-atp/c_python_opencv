...
#define MKTYPE2_I(NAME) jasonnb##_##NAME##_specials(); if (!to_ok(&jasonnb##_##NAME##_Type)) return NULL;
#else
#define MKTYPE2(NAME) MKTYPE2_I(NAME)
#define MKTYPE2_I(NAME) jasonnb##_##NAME##_specials(); if (!to_ok(&jasonnb##_##NAME##_Type)) return
#endif
...
#include QUOTEME(build/jasonnb_generated_include.h)
...
#define PYOPENCV_TO  jasonnb_to
#define PYOPENCV_FROM  jasonnb_from
...
#include QUOTEME(build/jasonnb_generated_types.h)

#include QUOTEME(build/jasonnb_generated_funcs.h)
...
#include QUOTEME(build/jasonnb_generated_ns_reg.h)
...
#include QUOTEME(build/jasonnb_generated_type_reg.h)
...
#include QUOTEME(build/jasonnb_generated_type_publish.h)
